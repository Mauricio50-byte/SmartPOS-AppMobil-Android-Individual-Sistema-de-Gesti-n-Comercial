...
const MODULOS_DISPONIBLES = [
  ...
  { id: 'caja', nombre: 'Caja', descripcion: 'Control de apertura, cierre y movimientos de efectivo', tipo: 'SISTEMA' },
  { id: 'gastos', nombre: 'Gastos', descripcion: 'Registro y seguimiento de egresos del negocio', tipo: 'SISTEMA' },
  { id: 'deudas', nombre: 'Deudas y Cartera', descripcion: 'Control de créditos a clientes y deudas a proveedores', tipo: 'SISTEMA' },
  ...
  { id: 'reportes', nombre: 'Reportes', descripcion: 'Visualización y exportación de reportes operativos', tipo: 'SISTEMA' },
  { id: 'reportes-contables', nombre: 'Contabilidad', descripcion: 'Estados de resultados, balances y reportes contables', tipo: 'SISTEMA' },
  { id: 'configuracion', nombre: 'Configuración', descripcion: 'Datos del negocio y preferencias', tipo: 'SISTEMA' },
  { id: 'notificaciones', nombre: 'Notificaciones', descripcion: 'Alertas de stock, vencimientos y mensajes', tipo: 'SISTEMA' },
